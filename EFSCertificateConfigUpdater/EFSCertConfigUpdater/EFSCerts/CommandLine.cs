...
//    10/23/2004 Added user specified help text, formatting of help text to screen width. Added ParseHelp for /?.
//    This version was mentioned here: http://blogs.msdn.com/peterhal/archive/2004/10/23/246731.aspx
//
//    11/23/2004 Added support for default values.
//    This version was mentioned here: http://blogs.msdn.com/peterhal/archive/2004/11/23/268698.aspx
//    This version was incorporated here: http://svn.castleproject.org:8080/svn/castlecontrib/codegenerator/trunk/Castle.Tools.CodeGenerator.CmdLine/CommandLineArguments.cs
//
//    The last version of the gotdotnet page is archived here: http://web.archive.org/web/20071224231440/http://www.gotdotnet.com/Community/UserSamples/Details.aspx?SampleGuid=62a0f27e-274e-4228-ba7f-bc0118ecc41e
...
namespace CommandLine
{
    ...
    public sealed class Parser
    {
        ...
        /// <summary>
        /// Parses Command Line Arguments. Displays usage message to Console.Out if /?, /help or invalid arguments are encountered.
        ...
        private ArgumentHelpStrings[] GetAllHelpStrings()
        {
            ...
            // 2008-11-23: commenting this @<file> argument out of the help text, as it's just confusing.
        ...
        private bool LexFileArguments(string fileName, out string[] arguments)
        {
            ...
            catch (Exception e)
            {
                ...
                arguments = null;
                // 2008-11-22 The following line of code has an error, according to http://web.archive.org/web/20071224231440/http://www.gotdotnet.com/Community/UserSamples/Details.aspx?SampleGuid=62a0f27e-274e-4228-ba7f-bc0118ecc41e
                // I've updated it with the fix
                // return false;
                return true;
            }
